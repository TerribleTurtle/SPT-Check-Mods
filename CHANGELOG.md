...
This release incorporates structural changes to the command-line interface, output formatting, dependency injection initialization, and cross-platform compilation capabilities, as well as introducing a full Web Manager GUI.
