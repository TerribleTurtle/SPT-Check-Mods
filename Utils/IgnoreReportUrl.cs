...
internal static class IgnoreReportUrl
{
    ...
    private const string BaseUrl =
        "https://github.com/TerribleTurtle/CheckModsExtended/issues/new?template=report-ignored-updates.yml";
    ...
    [UnconditionalSuppressMessage(
        "Trimming",
        "IL2026",
        Justification = "JsonSerializerOptions contains the correct TypeInfoResolver from source generation."
    )]
