...
public sealed class FakeModCheckReporter : IModCheckReporter
{
    ...
    public List<string> ValidatedSptVersions
    {
        get { return _validatedSptVersions.ToList(); }
    }
    ...
    {
        _warnings.Add($"CouldNotReadModDll: {fileName} - {reason}");
    }

    /// <inheritdoc />
    public void CouldNotReadSptVersion(string reason)
    {
        _warnings.Add($"CouldNotReadSptVersion: {reason}");
    }

    /// <inheritdoc />
    public void PluginsDirectoryNotFound(string path)
    {
        _warnings.Add($"PluginsDirectoryNotFound: {path}");
    }
    ...
    {
        _errors.Add($"DirectoryDoesNotExist: {path}");
    }
    ...
    {
        _validatedSptVersions.Add(version);
    }
    ...
    /// <inheritdoc />
    public void CheckModsExtendedUpdate(CheckModsExtendedUpdateResult result, Version sptVersion) { }
    ...
    {
        return PromptFetchRemoteIgnoresResult;
    }
    ...
    {
        return PromptReportIgnoresResult;
    }
